...
- [ ] **[HUMAN]** Flash Raspberry Pi OS to MicroSD card (AC: 1, 2, 3)
  - [ ] **[HUMAN]** Download and install Raspberry Pi Imager on development PC
  - [ ] **[HUMAN]** Insert 16-32GB MicroSD card into PC card reader
  - [ ] **[HUMAN]** Open Raspberry Pi Imager, select "Raspberry Pi OS Lite (64-bit)" from OS list
  - [ ] **[HUMAN]** Select MicroSD card as storage device
  - [ ] **[HUMAN]** Click gear icon to configure advanced options:
    - [ ] Enable SSH with password authentication
    - [ ] Set username and password (e.g., username: pi, password: [secure password])
    - [ ] Configure WiFi SSID and password for local network
    - [ ] Set locale settings (timezone, keyboard layout)
  - [ ] **[HUMAN]** Click "Write" to flash OS to MicroSD card
  - [ ] **[HUMAN]** Wait for write and verification to complete
  - [ ] **[HUMAN]** Safely eject MicroSD card

- [ ] **[HUMAN]** Boot Raspberry Pi and verify SSH access (AC: 4)
  - [ ] **[HUMAN]** Insert MicroSD card into Raspberry Pi Zero 2 W
  - [ ] **[HUMAN]** Connect power supply to Raspberry Pi (micro USB, 5V 2.5A recommended)
  - [ ] **[HUMAN]** Wait 60-90 seconds for initial boot and WiFi connection
  - [ ] **[HUMAN]** From development PC, attempt SSH connection: `ssh pi@raspberrypi.local`
  - [ ] **[HUMAN]** Accept SSH fingerprint when prompted
  - [ ] **[HUMAN]** Enter password to authenticate
  - [ ] **[HUMAN]** Verify successful SSH login (command prompt shows `pi@raspberrypi:~ $`)

**🤖 AI AGENT CAN EXECUTE (via SSH):**

- [ ] Configure static IP or verify hostname resolution (AC: 5)
  - [ ] Test hostname resolution: `ping raspberrypi.local` from development PC
...
**SSH Access Methods:**
1. **Hostname (recommended for development):** `ssh pi@raspberrypi.local`
...
2. **Static IP (recommended for production):** `ssh pi@192.168.1.100`
